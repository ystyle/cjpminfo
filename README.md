...
```toml
[dependencies]
cjpminfo = { git = "https://github.com/ystyle/cjpminfo.git", branch = "main", output-type = "static"}
```

### 方式二：本地 path 依赖

将 cjpminfo 克隆到你的项目目录旁边：

```bash
cd ~/Code/Cangjie
git clone https://github.com/ystyle/cjpminfo.git
```
...
let version: String = @ModuleVer("0.0.1")
